...
show_ads: true
description: Dumbarton's triangle and beam-of-light reports show how modern UFO databases can preserve intriguing but fragile local claims.
hero_summary: Dumbarton's triangle and beam-of-light reports show how modern UFO databases can preserve intriguing but fragile local claims.
layout: default
permalink: /dumbarton-reports/
sidebar_expanded_urls:
- /what-really-happened-in-dunbartonshire/
nav_short_title: Dumbarton Reports
title: Were Dumbarton's Triangle Sightings Ever Strong Evidence?
title_full: Were Dumbarton's Triangle Sightings Ever Strong Evidence?
display_title_short: Dumbarton Reports
display_title: Dumbarton Reports
heading_title: Were Dumbarton's Triangle Sightings Ever Strong Evidence?
page_heading_title: Were Dumbarton's Triangle Sightings Ever Strong Evidence?
source_count: 85
infographic_count: 3
planned_sections:
...
- basename: Dunbartonshire_abd4f2_faslane_lights_48ce74
  title: Faslane Lights | What Really Happened in Dunbartonshire Skies?
...
header:
  og_image: /assets/images/Dunbartonshire_abd4f2_dumbarton_triangle_r_cdfe78-overview-social.jpg
  preview_image: /assets/images/Dunbartonshire_abd4f2_dumbarton_triangle_r_cdfe78-overview.webp
image: /assets/images/Dunbartonshire_abd4f2_dumbarton_triangle_r_cdfe78-overview-social.jpg
---

## Introduction

Dumbarton’s recent triangle and beam-of-light reports are interesting, but they are not strong proof of an extraordinary craft over [Dunbartonshire]({{ 'what-really-happened-in-dunbartonshire/' | relative_url }}). Their real value is more modest and more useful: they show how modern UFO databases can preserve local claims that would otherwise disappear, while also exposing how fragile those claims remain when there is no photograph, named witness, second observer, flight-path check, meteor check, police log or official investigation attached.


<img src="{{ "/assets/images/Dunbartonshire_abd4f2_dumbarton_triangle_r_cdfe78-overview.webp" | relative_url }}" alt="Overview image for Dumbarton Reports" loading="eager" decoding="sync" fetchpriority="high">
