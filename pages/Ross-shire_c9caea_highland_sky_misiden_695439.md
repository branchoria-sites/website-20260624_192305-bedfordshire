...
show_ads: true
description: Dark skies, bright planets, meteors, aurora and broken cloud can make sincere Ross-shire reports hard to judge.
hero_summary: Dark skies, bright planets, meteors, aurora and broken cloud can make sincere Ross-shire reports hard to judge.
layout: default
permalink: /sky-clues-e9db73/
sidebar_expanded_urls:
- /what-really-happened-in-ross-shires-ufo/
nav_short_title: Sky Clues
title: Why Highland Skies Can Fool Witnesses
title_full: Why Highland Skies Can Fool Witnesses
display_title_short: Sky Clues
display_title: Sky Clues
heading_title: Why Highland Skies Can Fool Witnesses
page_heading_title: Why Highland Skies Can Fool Witnesses
source_count: 97
infographic_count: 3
planned_sections:
...
header:
  og_image: /assets/images/Ross-shire_c9caea_highland_sky_misiden_695439-overview-social.jpg
  preview_image: /assets/images/Ross-shire_c9caea_highland_sky_misiden_695439-overview.webp
image: /assets/images/Ross-shire_c9caea_highland_sky_misiden_695439-overview-social.jpg
---
...
This is also where county-level UFO history benefits from local sky knowledge. A purple-and-green light in a dark northern county has to be assessed differently from the same description in a southern city under heavy light pollution. The colours are not proof of aurora, but they are evidence that aurora, atmospheric scattering and low-light perception belong near the top of the explanation list.
...
## What a Good Ross-shire Check Would Ask First
...
* **Direction and elevation:** Was the object low over a hill, near the horizon, or high overhead?
* **Duration:** Did it last two seconds, two minutes, or half an hour?
* **Motion:** Did it cross the sky, remain fixed, drift with cloud, or change direction?
* **Weather:** Was there broken cloud, haze, rain, frost, or auroral activity?
* **Independent witnesses:** Did anyone see the same object from another place in Ross-shire or a neighbouring county?
* **Astronomical checks:** Were Venus, Jupiter, Mars, a bright star, a meteor shower or a known fireball in the relevant part of the sky?
* **Aviation checks:** Was there aircraft traffic, military activity, or a head-on approach path that could make lights appear stationary?

</div>

These questions do not make a report less interesting. They make it more useful. A weakly sourced UFO entry can still tell us something about how people experience the Highland night sky. A better-sourced entry, with direction, duration and corroboration, can separate a likely misidentification from something genuinely unresolved.
...
The ordinary explanations are not a side note to Ross-shire’s UFO record. They are the main interpretive framework. In a dark county with wide horizons, hills, firths, aurora potential and broken cloud, the first mystery is often not what object was in the sky, but how the sky made it look.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides examples of recurring witness mistakes and mysteries.</p>
        <div class="fr-book-actions">
