...
show_ads: true
description: The MoD records show scattered reports around Gaydon, Warwick, Coventry Airport, Bedworth and Stratford rather than a secret case file.
hero_summary: The MoD records show scattered reports around Gaydon, Warwick, Coventry Airport, Bedworth and Stratford rather than a secret case file.
layout: default
permalink: /mo-d-records-103f76/
sidebar_expanded_urls:
- /what-really-happened-in-warwickshires/
nav_short_title: Mo D Records
title: What the Mo D Logs Reveal About Warwickshire
title_full: What the Mo D Logs Reveal About Warwickshire
display_title_short: Mo D Records
display_title: Mo D Records
heading_title: What the Mo D Logs Reveal About Warwickshire
page_heading_title: What the Mo D Logs Reveal About Warwickshire
source_count: 77
infographic_count: 3
planned_sections:
- The 1997 cluster
...
- basename: Warwickshire_17be07_leamington_black_rin_47ea8f
  title: Black Ring | What Really Happened in Warwickshire's UFO Stories?
...
next_link:
  ...
  short_title: Stratford 2007
  heading_title: Did Stratford Really See a UFO Crowd Event?
date: '2026-06-24 19:06:32 '
header:
  og_image: /assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-overview-social.jpg
  preview_image: /assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-overview.webp
image: /assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-overview-social.jpg
---

## Introduction

The Ministry of Defence records for [Warwickshire]({{ 'what-really-happened-in-warwickshires/' | relative_url }}) do not reveal a hidden county case file or a dramatic military confrontation. What they show is more useful, and more sober: a trail of short public sighting reports scattered across places such as Gaydon, Warwick, Coventry Airport, Bedworth, Stratford-upon-Avon and the Avon valley. The most concentrated Warwickshire entries appear in March 1997, followed by later late-2000s reports dominated by orange balls, coloured lights and brief descriptions rather than firm evidence.
...
<img src="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-1-dark.svg" | relative_url }}" alt="Mo D Records illustration 1" data-theme-src-dark="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The 1997 cluster
...
<img src="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-3-dark.svg" | relative_url }}" alt="Mo D Records illustration 3" data-theme-src-dark="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Warwickshire_17be07_mod_sighting_logs_28fe32-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to What the MoD Logs Reveal About Warwickshire. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses MoD UFO investigations, official reporting procedures, and the sort of sighting logs discussed on the page.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains UK UFO files, public records, and how reported sightings entered the historical record.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Focuses on evaluating official reports and witness evidence rather than treating sightings as proof.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for how prominent UK UFO incidents are investigated and debated.</p>
        <div class="fr-book-actions">
