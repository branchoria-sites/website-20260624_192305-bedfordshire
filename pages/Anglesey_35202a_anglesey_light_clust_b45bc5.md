...
show_ads: true
description: Later local reports around Holyhead, Beaumaris and the Menai Strait show how ordinary lights became part of Anglesey's UFO record.
hero_summary: Later local reports around Holyhead, Beaumaris and the Menai Strait show how ordinary lights became part of Anglesey's UFO record.
layout: default
permalink: /later-light-cluster-reports/
sidebar_expanded_urls:
- /what-really-happened-over-anglesey/
nav_short_title: Later Light Cluster Reports
title: Why Anglesey's Orange Lights Keep Reappearing
title_full: Why Anglesey's Orange Lights Keep Reappearing
display_title_short: Later Light Cluster Reports
display_title: Later Light Cluster Reports
heading_title: Why Anglesey's Orange Lights Keep Reappearing
page_heading_title: Why Anglesey's Orange Lights Keep Reappearing
source_count: 64
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Mo D Logs
  heading_title: What Do Anglesey's Mo D UFO Logs Show?
date: '2026-06-24 19:08:42 '
header:
  og_image: /assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-overview-social.jpg
  preview_image: /assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-overview.webp
image: /assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-overview-social.jpg
---

## Introduction

[Anglesey]({{ 'what-really-happened-over-anglesey/' | relative_url }})’s later light-cluster reports are less dramatic than the 1977 Rhosybol school sighting, but they are important because they show how the island’s UFO record kept renewing itself through ordinary lights seen from familiar coastal places. The core pattern is simple: brief reports from Holyhead, [RAF Valley]({{ 'raf-valley/' | relative_url }}), Beaumaris and the Menai Strait describe bright stars, coloured pulses, amber egg-shaped objects, orange triangular lights and fuzzy orange balls. The best reading is not that these reports prove a single mystery object over Anglesey, but that the island’s geography made ambiguous lights unusually memorable: sea horizons, dark rural skies, RAF activity, shipping lights, lighthouse flashes, sky lanterns and public awareness of UFO files all fed into the same local folklore. The result is a cluster of sightings that is historically useful, even where the evidence is thin.
...
<img src="{{ "/assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-Illustration-2-dark.svg" | relative_url }}" alt="Later Light Cluster Reports illustration 2" data-theme-src-dark="{{ "/assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Anglesey_35202a_anglesey_light_clust_b45bc5-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides broader context for modern reports and public perception.</p>
        <div class="fr-book-actions">
