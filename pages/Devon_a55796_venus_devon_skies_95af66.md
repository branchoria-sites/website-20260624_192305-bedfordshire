...
show_ads: true
description: Many Devon sightings make more sense when bright planets, haze, moving cars, sea horizons and broken cloud are taken seriously.
hero_summary: Many Devon sightings make more sense when bright planets, haze, moving cars, sea horizons and broken cloud are taken seriously.
layout: default
permalink: /sky-clues/
sidebar_expanded_urls:
- /what-really-happened-in-devons-ufo-skies/
nav_short_title: Sky Clues
title: Could Venus Explain Devon's UFO Reports?
title_full: Could Venus Explain Devon's UFO Reports?
display_title_short: Sky Clues
display_title: Sky Clues
heading_title: Could Venus Explain Devon's UFO Reports?
page_heading_title: Could Venus Explain Devon's UFO Reports?
source_count: 146
infographic_count: 3
planned_sections:
...
header:
  og_image: /assets/images/Devon_a55796_venus_devon_skies_95af66-overview-social.jpg
  preview_image: /assets/images/Devon_a55796_venus_devon_skies_95af66-overview.webp
image: /assets/images/Devon_a55796_venus_devon_skies_95af66-overview-social.jpg
---

## Introduction

Could Venus explain [Devon]({{ 'what-really-happened-in-devons-ufo-skies/' | relative_url }})’s UFO reports? Sometimes, yes — and the 1967 North Devon “[flying cross]({{ 'flying-cross/' | relative_url }})” is the clearest reason this question belongs in any serious Devon UFO history. The useful answer is not that every strange light over Devon is Venus, nor that witnesses who report odd skies are careless. It is that Devon’s coasts, moors, night roads, broken cloud and sea horizons can make ordinary lights look larger, closer, lower or more mobile than they really are. In official and sceptical records, Venus repeatedly appears not as a lazy dismissal, but as a practical test: was the sighting in the right part of the sky, at the right time, with the right behaviour for a bright planet?
...
<img src="{{ "/assets/images/Devon_a55796_venus_devon_skies_95af66-Illustration-2-dark.svg" | relative_url }}" alt="Sky Clues illustration 2" data-theme-src-dark="{{ "/assets/images/Devon_a55796_venus_devon_skies_95af66-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Devon_a55796_venus_devon_skies_95af66-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains how astronomical misunderstandings arise, making it useful background for evaluating Venus-related UFO reports.</p>
        <div class="fr-book-actions">
