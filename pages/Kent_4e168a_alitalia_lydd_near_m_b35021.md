...
show_ads: true
description: The 1991 Alitalia near-miss remains Kent's strongest modern UFO case because pilots, radar and official safety checks all mattered.
hero_summary: The 1991 Alitalia near-miss remains Kent's strongest modern UFO case because pilots, radar and official safety checks all mattered.
layout: default
permalink: /alitalia/
sidebar_expanded_urls:
- /what-really-happened-over-kent/
nav_short_title: Alitalia
title: The Airliner Near Miss That Put Lydd on UFO Maps
title_full: The Airliner Near Miss That Put Lydd on UFO Maps
display_title_short: Alitalia
display_title: Alitalia
heading_title: The Airliner Near Miss That Put Lydd on UFO Maps
page_heading_title: The Airliner Near Miss That Put Lydd on UFO Maps
source_count: 91
infographic_count: 3
planned_sections:
- What the Alitalia crew reported
- Radar, CAA and Mo D follow up
...
next_link:
  ...
  short_title: Hotspots
  heading_title: Why Kent Skies Produce So Many UFO Reports
date: '2026-06-24 19:05:34 '
header:
  og_image: /assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-overview-social.jpg
  preview_image: /assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-overview.webp
image: /assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-overview-social.jpg
---
...
The Alitalia near-miss remains unresolved because its strongest pieces of evidence do not quite lock together into a single, testable identification. There were trained pilots, a dramatic cockpit reaction, an apparently close pass, an air traffic control query, official follow-up and later archival release. Those are real strengths. Yet the sighting itself was brief, the object was not photographed, no debris was recovered, and the public radar detail is too thin to prove a precise match with the visual observation.
...
<img src="{{ "/assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-Illustration-3-dark.svg" | relative_url }}" alt="Alitalia illustration 3" data-theme-src-dark="{{ "/assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Kent_4e168a_alitalia_lydd_near_m_b35021-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How it fits Kent’s wider UFO record

Within Kent, the Alitalia incident stands out because it belongs to an aviation-and-records strand rather than a folklore strand. It is not mainly a story about strange lights over a town, nor a local legend passed through retellings. It is a case rooted in pilots, air traffic control, the CAA, the MoD and a specific Kent location. That makes it a natural companion to other aviation-heavy Kent cases, especially the RAF [Manston]({{ 'manston/' | relative_url }}) and Milton Torres incident, while remaining a separate event with its own evidence problems.

It also shows why Kent is unusually fertile ground for serious UFO reports. The county faces the Channel and the Strait of Dover, sits under busy south-east airspace, contains historic and modern aviation sites, and has military-linked coastal areas. In that environment, unexplained reports are more likely to be noticed by trained observers and more likely to trigger official paperwork. At the same time, the same environment supplies many possible non-extraordinary explanations.

For a Kent UFO map or county case index, the Alitalia near-miss deserves prominent placement because it is one of the few local cases where the evidential chain goes beyond a witness anecdote. The core evidence is still incomplete, but the combination of cockpit witnesses, reported radar interest and official investigation gives it a higher evidential floor than most sightings. Its unresolved status should be preserved carefully: not debunked, not confirmed as exotic, and not safe to inflate beyond the record.
