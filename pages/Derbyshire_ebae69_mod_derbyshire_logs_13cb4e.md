...
show_ads: true
description: The MoD files show what Derbyshire residents reported, but short log entries are not the same as solved investigations.
hero_summary: The MoD files show what Derbyshire residents reported, but short log entries are not the same as solved investigations.
layout: default
permalink: /mo-d-logs/
...
header:
  og_image: /assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-overview-social.jpg
  preview_image: /assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-overview.webp
image: /assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-overview-social.jpg
---
...
<img src="{{ "/assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-Illustration-3-dark.svg" | relative_url }}" alt="Mo D Logs illustration 3" data-theme-src-dark="{{ "/assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Derbyshire_ebae69_mod_derbyshire_logs_13cb4e-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
