...
show_ads: true
description: The MoD records turn scattered Middlesex sightings into a pattern of logged reports, especially during the late-2000s orange-light wave.
hero_summary: The MoD records turn scattered Middlesex sightings into a pattern of logged reports, especially during the late-2000s orange-light wave.
layout: default
permalink: /mo-d-logs-2a5a09/
sidebar_expanded_urls:
- /what-makes-middlesexs-ufo-record/
nav_short_title: Mo D Logs
title: What the Mo D logs reveal
title_full: What the Mo D logs reveal
display_title_short: Mo D Logs
display_title: Mo D Logs
heading_title: What the Mo D logs reveal
page_heading_title: What the Mo D logs reveal
source_count: 68
infographic_count: 3
planned_sections:
...
header:
  og_image: /assets/images/Middlesex_8498da_mod_orange_lights_d395db-overview-social.jpg
  preview_image: /assets/images/Middlesex_8498da_mod_orange_lights_d395db-overview.webp
image: /assets/images/Middlesex_8498da_mod_orange_lights_d395db-overview-social.jpg
---
...
<img src="{{ "/assets/images/Middlesex_8498da_mod_orange_lights_d395db-Illustration-1-dark.svg" | relative_url }}" alt="Mo D Logs illustration 1" data-theme-src-dark="{{ "/assets/images/Middlesex_8498da_mod_orange_lights_d395db-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Middlesex_8498da_mod_orange_lights_d395db-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Harrow, Hayes, Ruislip and Heathrow entries
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to What the MoD logs reveal. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Focuses on British UFO records and the documentary evidence behind official files and sightings.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Uses material from official British UFO records, helping readers understand reporting patterns and witness descriptions.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for how major British UFO cases were recorded, debated and interpreted within the wider UK UFO landscape.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Offers wider context for UFO waves, recurring sighting patterns and unexplained aerial phenomena discussed in official records.</p>
        <div class="fr-book-actions">
