...
show_ads: true
description: The Brixham and Berry Head story is useful less as proof than as a lesson in how local UFO anecdotes survive without primary records.
hero_summary: The Brixham and Berry Head story is useful less as proof than as a lesson in how local UFO anecdotes survive without primary records.
layout: default
permalink: /berry-head/
sidebar_expanded_urls:
- /what-really-happened-in-devons-ufo-skies/
nav_short_title: Berry Head
title: What Happened to the Berry Head Record?
title_full: What Happened to the Berry Head Record?
display_title_short: Berry Head
display_title: Berry Head
heading_title: What Happened to the Berry Head Record?
page_heading_title: What Happened to the Berry Head Record?
source_count: 101
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Flying Cross
  heading_title: Why Devon's Flying Cross Still Matters
date: '2026-06-24 19:04:57 '
header:
  og_image: /assets/images/Devon_a55796_berry_head_records_g_8ae7d6-overview-social.jpg
  preview_image: /assets/images/Devon_a55796_berry_head_records_g_8ae7d6-overview.webp
image: /assets/images/Devon_a55796_berry_head_records_g_8ae7d6-overview-social.jpg
---
...
The Berry Head case sits in that uncomfortable middle ground. It has enough local and online afterlife to be remembered, but not enough surviving primary documentation to be weighed like the better-known North Devon “[flying cross]({{ 'flying-cross/' | relative_url }})” case later in 1967, which reached Parliament and attracted official comment. Berry Head’s evidential value is therefore not in proving an extraordinary object over Brixham. It is in showing how quickly the evidential floor can drop away beneath a story that sounds official.


<img src="{{ "/assets/images/Devon_a55796_berry_head_records_g_8ae7d6-Illustration-2-dark.svg" | relative_url }}" alt="Berry Head illustration 2" data-theme-src-dark="{{ "/assets/images/Devon_a55796_berry_head_records_g_8ae7d6-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Devon_a55796_berry_head_records_g_8ae7d6-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to weigh local memory against archives
