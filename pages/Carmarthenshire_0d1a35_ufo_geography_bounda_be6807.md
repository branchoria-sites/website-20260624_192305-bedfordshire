...
show_ads: true
description: County labels such as Dyfed can blur which reports truly belong to Carmarthenshire and which sit just over the line.
hero_summary: County labels such as Dyfed can blur which reports truly belong to Carmarthenshire and which sit just over the line.
layout: default
permalink: /boundaries-24cc0a/
sidebar_expanded_urls:
- /what-really-happened-over-ecf221/
nav_short_title: Boundaries
title: Which Sightings Count as Carmarthenshire Cases?
title_full: Which Sightings Count as Carmarthenshire Cases?
display_title_short: Boundaries
display_title: Boundaries
heading_title: Which Sightings Count as Carmarthenshire Cases?
page_heading_title: Which Sightings Count as Carmarthenshire Cases?
source_count: 131
infographic_count: 3
planned_sections:
...
<img src="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-2-dark.svg" | relative_url }}" alt="Boundaries illustration 2" data-theme-src-dark="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/1QqsDSEJMuQ" title="APEC 5/9: Llanilar UAP Sample Analysis &amp; The VEM Drive" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=1QqsDSEJMuQ" target="_blank" rel="noopener noreferrer">APEC 5/9: Llanilar UAP Sample Analysis &amp; The VEM Drive</a></p><p class="youtube-embed-meta">Channel: Alt Propulsion</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=1QqsDSEJMuQ" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=1QqsDSEJMuQ">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-3-dark.svg" | relative_url }}" alt="Boundaries illustration 3" data-theme-src-dark="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Carmarthenshire_0d1a35_ufo_geography_bounda_be6807-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding how older reports become part of regional UFO folklore.</p>
        <div class="fr-book-actions">
