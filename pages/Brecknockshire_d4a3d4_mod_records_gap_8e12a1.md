...
show_ads: true
description: The county's UFO history is shaped as much by how official records were filed as by what witnesses said they saw.
hero_summary: The county's UFO history is shaped as much by how official records were filed as by what witnesses said they saw.
layout: default
permalink: /mo-d-records-b10880/
sidebar_expanded_urls:
- /what-really-happened-over-brecknockshire/
nav_short_title: Mo D Records
title: Why Brecknockshire UFO Records Are So Patchy
title_full: Why Brecknockshire UFO Records Are So Patchy
display_title_short: Mo D Records
display_title: Mo D Records
heading_title: Why Brecknockshire UFO Records Are So Patchy
page_heading_title: Why Brecknockshire UFO Records Are So Patchy
source_count: 86
infographic_count: 3
planned_sections:
- What the Mo D said it investigated
- Why county searches are difficult
- How archives, press and local groups fit together
...
header:
  og_image: /assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-overview-social.jpg
  preview_image: /assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-overview.webp
image: /assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-overview-social.jpg
---
...
The best reading is therefore layered. A Brecon Beacons light report may be shaped by dark-sky visibility, road perspective, aircraft routes, training activity, weather, stars, planets, satellites or lanterns. It may still remain unidentified to the witness. The MoD record usually helps only if it preserves enough detail to check those possibilities. In Brecknockshire, the surviving public traces often do not.
...
<img src="{{ "/assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-Illustration-3-dark.svg" | relative_url }}" alt="Mo D Records illustration 3" data-theme-src-dark="{{ "/assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Brecknockshire_d4a3d4_mod_records_gap_8e12a1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What the patchiness means for Brecknockshire’s UFO history

The main conclusion is not that Brecknockshire has no UFO history. It is that its UFO history is unusually dependent on fragments: a Brecon road report in a national MoD file index, a correspondence query about a local leisure-centre sighting, a Brecon Beacons police-database entry sitting partly outside the historic county frame, and broader MoD lists that were never organised for county storytelling.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/nTh9W9Ki3Iw" title="The Entire History of Brecon // Ancient Welsh History Archaeology Documentary" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=nTh9W9Ki3Iw" target="_blank" rel="noopener noreferrer">The Entire History of Brecon // Ancient Welsh History Archaeology Documentary</a></p><p class="youtube-embed-meta">Channel: Pete Kelly</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=nTh9W9Ki3Iw" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=nTh9W9Ki3Iw">Open on YouTube</a></p></div></div></div>

## What would strengthen or weaken the record
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides a structured way to think about incomplete records.</p>
        <div class="fr-book-actions">
